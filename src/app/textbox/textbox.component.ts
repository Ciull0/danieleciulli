    ...
    'content': [
      {
        ...
        'body': 'body',
        'link_esterno': 'link',
        'link_interno': 'altrolink',
        'footer': "footer"
      }
    ]
  }
  testoDaInserire:string = "";

  constructor(
    private salitazer: DomSanitizer) { }

  ngOnInit(): void {
    this.testoDaInserire = this.makeNewLine(this.putLink(this.makeBold(this.makeRed(this.makeUnderline(this.makeItalics(this.data.content[0].body))))));
  }
